...
namespace lbm
{
    ...
    template<> struct SimulationData<lbm::access::LBMCollisionAccessor>
    {
        ...
        std::shared_ptr<lbm::access::LBMCollisionAccessor> lbm_accessor;
         ...
         * @param properties the extents of the lattice specified in this Properties structure are used for initialization
         */
        explicit SimulationData<lbm::access::LBMCollisionAccessor>
        (
            const Properties &properties
        )
        :
        ...
        end_node_index_non_buffered(properties.non_buffered_node_count),
        end_node_index_buffered(properties.buffered_node_count),
        lbm_accessor(std::make_shared<lbm::access::LBMCollisionAccessor>(properties.horizontal_nodes))
        {};
    };
