...
{
  public:
    explicit PropertyArgumentException(const std::string &message,
                                       const std::source_location &source_location = std::source_location::current());
};
...
{
  public:
    explicit MissingPropertyException(const std::string &message,
                                      const std::source_location &source_location = std::source_location::current());
};
...
{
  public:
    explicit UnknownPropertyException(const std::string &message,
                                      const std::source_location &source_location = std::source_location::current());
};
...
{
  public:
    explicit OutOfDomainException(const std::string &message,
                                  const std::source_location &source_location = std::source_location::current());
};
...
{
  public:
    explicit WaitException(const std::string &message,
                           const std::source_location &source_location = std::source_location::current());
};
