...
// Debug optimized two-lattice ///////////////////////////////////////////////////////////////////////////////////////
                ...
                class OptimizedGpuTwoLatticeDebug : public execution::SYCLAlgorithm
                {
                    ...
                    void stream()
                    {
                        ...
                        (
                            [&](sycl::handler &cgh)
                            {
                                auto kernel = optimized::kernels::StreamKernel<A>(*simulation);
                                cgh.parallel_for(
                                    sycl::nd_range<2>(
                                        sycl::range<2>(
                                            simulation->domain->vertical_nodes,
                    ...
                    void update_macroscopic_observables()
                    {
                        ...
                        (
                            [&](sycl::handler &cgh)
                            {
                                auto kernel = optimized::kernels::MacroscopicObservablesKernel<A>(*simulation);
                                cgh.parallel_for(
                                    sycl::nd_range<2>(
                                        sycl::range<2>(
                                            simulation->domain->vertical_nodes,
                    ...
                    void collide()
                    {
                        ...
                        (
                            [&](sycl::handler &cgh)
                            {
                                auto kernel = optimized::kernels::CollideKernel<A>(*simulation);
                                cgh.parallel_for(
                                    sycl::nd_range<2>(
                                        sycl::range<2>(
                                            simulation->domain->vertical_nodes,
                ...
                /**
                 * @brief   Initializes a `lbm::gpu::two_lattice::optimized::OptimizedGpuTwoLattice` algorithm object and 
                 ...
                 * 
                 * @return  a unique pointer to a `lbm::gpu::two_lattice::optimized::OptimizedGpuTwoLattice` object
                 */
                ...
                /**
                 * @brief   Initializes a `lbm::gpu::two_lattice::optimized::OptimizedGpuTwoLatticeDebug` algorithm object and 
                 *          returns a unique pointer to this object.
                 * 
                 * @param[in]   properties  the data layout and scenario are determined from this object
                 * @param[in]   queue       the SYCL queue on which the algorithm operates.
                 * 
                 * @return  a unique pointer to a `lbm::gpu::two_lattice::optimized::OptimizedGpuTwoLatticeDebug` object
                 */
